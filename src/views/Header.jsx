...
function Header({ address, token, tokenName }) {
  return ( 
    <header className="header">
      <Grid>
        <Col xs={12}>
          <a target="_blank" href="https://propsproject.com" rel="noopener noreferrer">
            <img className="logo hidden-xs hidden-sm" src="/logo-propsproject.png" alt="OpenZeppelin logo" />
          </a>
